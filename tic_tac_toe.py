...
class ticTacToe:
    def __init__(self):
        self.reset() #attribute (variables with the .self prefix)

    def print_board(self): #method (functions inside a class)
        print("")
    ...
    def reset(self): #method
        self.board = [[" ", " ", " "], [" ", " ", " "], [" ", " ", " "]] #attribute
        self.done = "" #attribute

    def check_win_or_draw(self): #method
        dict_win = {}
    ...
    def get_player_move(self): #method
        invalid_move = True
